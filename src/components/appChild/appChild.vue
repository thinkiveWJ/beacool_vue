<template>
  <div id="appChild" class="main-navi container">
    ...
    <div class="row download">
      ...
      <div class="col-md-2 col-xs-4"><a href="http://dl.beacool.com/versions.html?sid=20021"><img v-lazy="'/beacool/static/images/android.png'"></a></div>
      <div class="col-md-2 col-xs-4"><a><img v-lazy="'/beacool/static/images/download_code.png'"></a></div>
      <div class="clearfix"></div>
      <v-concat></v-concat>
    </div>
    <v-footer></v-footer>
